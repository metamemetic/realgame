...
function Entities(arca, opts) {
	...
	this.names.position = this.createComponent(require('../components/position')(arca))
	this.names.physics = this.createComponent(require('../components/physics')(arca))
	this.names.followsEntity = this.createComponent(require('../components/followsEntity')(arca))
	this.names.mesh = this.createComponent(require('../components/mesh')(arca))
	this.names.shadow = this.createComponent(require('../components/shadow')(arca, shadowDist))
	this.names.collideTerrain = this.createComponent(require('../components/collideTerrain')(arca))
	this.names.collideEntities = this.createComponent(require('../components/collideEntities')(arca))
	this.names.smoothCamera = this.createComponent(require('../components/smoothCamera')(arca))
	this.names.movement = this.createComponent(require('../components/movement')(arca))
	this.names.receivesInputs = this.createComponent(require('../components/receivesInputs')(arca))
	this.names.fadeOnZoom = this.createComponent(require('../components/fadeOnZoom')(arca))

	// decorate the entities object with accessor functions
	this.isPlayer = function (id) { return id === arca.playerEntity }
	...
	// events
	var self = this
	arca.on('tick', function (dt) { self.tick(dt) })
	arca.on('beforeRender', function (dt) { self.render(dt) })
...
Entities.prototype.add = function (position, width, height, // required
	...
	if (doPhysics) {
		// body = this.arca.physics.addBody(box)

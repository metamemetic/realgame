...
function ObjectMesher() {
    ...
    */
    ...
    this.buildObjectMesh = function (chunk) {
        ...
        var scene = chunk.arca.rendering.getScene()
        var objectMeshLookup = chunk.arca.registry._blockMeshLookup
    ...
    function buildSPSforMaterialIndex(chunk, scene, meshHash, x0, y0, z0) {
        ...
        var blockHandlerLookup = chunk.arca.registry._blockHandlerLookup
        var objectMeshLookup = chunk.arca.registry._blockMeshLookup

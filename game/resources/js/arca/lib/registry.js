...
function Registry(arca, _options) {
    this.arca = arca
    ...
    */
     ...
     *  * blockMeshes: (null) if specified, arca will create an instance of the mesh instead of rendering voxel terrain

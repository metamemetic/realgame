...
function World(arca, _opts) {
    ...
    var self = this
    arca.on('beforeRender', function () { beforeRender(self) })
...
World.prototype.getBlockOpacity = function (x, y, z) {
    ...
    return this.arca.registry.getBlockOpacity(id)
}

/** @param x,y,z */
World.prototype.getBlockFluidity = function (x, y, z) {
    var id = this.getBlockID(x, y, z)
    return this.arca.registry.getBlockFluidity(id)
}

/** @param x,y,z */
World.prototype.getBlockProperties = function (x, y, z) {
    var id = this.getBlockID(x, y, z)
    return this.arca.registry.getBlockProps(id)
}
...
World.prototype.setChunkData = function (id, array, userData) {
    ...
    this.arca.rendering.prepareChunkForRendering(chunk)
...
function getPlayerChunkCoords(world) {
    var pos = world.arca.getPlayerPosition()
...
function requestNewChunk(world, id) {
    ...
    var chunk = new Chunk(world.arca, id, i, j, k, size)
...
function removeChunk(world, i, j, k) {
    ...
    world.arca.rendering.disposeChunkForRendering(chunk)
    chunk.dispose()
